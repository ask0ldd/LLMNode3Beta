...
const question1 = "Which is the most known track of the band Combichrist?"
...
const searchQueryObject = await AIAgenticLibrary.searchQueryProducerAgent.resetContext().setRequest(question1).setRegexOutputValidator(/^\{"searchQuery" : ".*"\}$/).call()
...
`You are an expert assistant. Your role is to use the information in a given chunk of text to answer a given question in the most concise way possible. 
